(() => {
    ...
    (() => {
            ...
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    if (selectItems.length) {
                        ...
                        this.setLogging(`Прокинувся, побудував селектів: (${selectItems.length})`);
        ...
        function initSliders() {
            if (document.querySelector(".body-main-slider__slider")) new core(".body-main-slider__slider", {
                ...
                on: {
                    init: function() {
                        ...
                        controll.forEach(((el, index) => {
                            let num = index + 1 < 10 ? "0" : "";
                            el.textContent = `${num}${index + 1}`;
                        }));
                    }
                }
            });
            if (document.querySelector(".blog-mainpage__slider")) new core(".blog-mainpage__slider", {
        ...
        parallax_Parallax.Each = class {
            ...
            parameters(el, parameters) {
                if ("v" == parameters.axis) el.style.transform = `translate3D(0, ${(parameters.direction * (this.value / parameters.coefficient)).toFixed(2) / 4}px,0) ${parameters.additionalProperties}`; else if ("h" == parameters.axis) el.style.transform = `translate3D(${(parameters.direction * (this.value / parameters.coefficient)).toFixed(2) / 4}px,0,0) ${parameters.additionalProperties}`;
            }
        };
        ...
        function headerScroll() {
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                if (scrollTop >= startPoint) {
                    ...
                    if (headerShow) {
                        if (scrollTop > scrollDirection) header.classList.contains("_header-show") ? header.classList.remove("_header-show") : null; else header.classList.contains("_header-show") ? header.classList.remove("_header-show") : null;
                        timer = setTimeout((() => {
...
***************************************************************************** */
        ...
        window.addEventListener("load", (function(e) {
            ...
            const menuContainer = document.querySelector(".menu-mainpage");
            const menuBarLink = document.querySelector("#bar-menu");
            const menuFoodLink = document.querySelector("#food-menu");
            const menuDessertsLink = document.querySelector("#desserts-menu");
            menuBarLink.addEventListener("mouseenter", (() => {}));
            menuDessertsLink.addEventListener("mouseenter", (() => {
                menuContainer.classList.add("menuDessertsBg");
            }));
            menuDessertsLink.addEventListener("mouseleave", (() => {
                menuContainer.classList.remove("menuDessertsBg");
            }));
            menuFoodLink.addEventListener("mouseenter", (() => {
                menuContainer.classList.add("menuFoodBg");
            }));
            menuFoodLink.addEventListener("mouseleave", (() => {
                menuContainer.classList.remove("menuFoodBg");
            }));
        }));
        window["FLS"] = true;
        isWebp();
